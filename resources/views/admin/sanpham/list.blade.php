                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a class="btn btn-outline-success" href="{{url('admin/san-pham/cap-nhat/'.$sp->id)}}"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
                            <td>
                                <form action="{{url('admin/san-pham/xoa/'.$sp->id)}}" method="post">
                                    @method('delete')
                                    @csrf
