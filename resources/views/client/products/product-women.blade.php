	...
	<div class="bg0 m-t-23 p-b-140">
		<div class="container">
			<div class="flex-w flex-sb-m p-b-52">
				<div class="flex-w flex-l-m filter-tope-group m-tb-10">
                    ...
                    @foreach ($dslsp as $lsp)
                        <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".women{{$lsp->id}}">
                            {{$lsp->ten_loai}}
                        </button>
                    @endforeach
				</div>
			...
			<div class="row isotope-grid">
                @foreach ($dssp as $sp)
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women{{$sp->ma_loai}}">
					<!-- Block2 -->
					<div class="block2">
